...
module.exports = function(home, options){
  ...
  var nodeHelpers = require('./node-helpers');
  var npmHelpers = require('./npm-helpers')(home, initialWd);
  var configHelpers = require('./config-helpers')(home);
  var applicationHelpers = require('./application-helpers')(configHelpers, routes, defaultAppsPort);
  var pluginHelpers = require('./plugin-helpers')(configHelpers);
