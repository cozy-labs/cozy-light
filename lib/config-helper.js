...
module.exports = function(){
  ...
  var configHelpers = {
    ...
    init: function (home) {
      ...
      configHelpers.setHomePath(home);
      configHelpers.copyDependency('pouchdb');
      configHelpers.createConfigFile();
      configHelpers.watcher = configWatcher(configHelpers.getConfigPath());
     ...
     */
    setHomePath: function (h) {
      home = pathExtra.resolve(h);
    },
    ...
    enable: function (apporplugin) {
      if (config.plugins[apporplugin] !== undefined) {
        ...
        throw new Error(
          'Cannot enable, given app or plugin ' + apporplugin + ' is not configured.');
      }
    },
    ...
    disable: function (apporplugin) {
      if (config.plugins[apporplugin] !== undefined) {
        ...
        throw new Error(
          'Cannot disable, given app or plugin ' + apporplugin + ' is not configured.');
      }
    },
